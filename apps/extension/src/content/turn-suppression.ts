...
export interface TurnSuppressionRegistry {
...
export class TurnSuppressionStore implements TurnSuppressionRegistry {
  public constructor(
  ...
  private async remember(ids: string[], remove: string[] = []): Promise<void> {
    ...
    await this.storage.set({
      [this.storageKey]: refreshed.slice(-this.limit)
    });
  }
}
